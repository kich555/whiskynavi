    ...
    <main className="min-h-screen bg-[#1d2429] pt-20 pb-12 text-white lg:pt-24 lg:pb-20">
      <div className="mx-auto max-w-4xl px-4 lg:px-10">
        <header className="border-b border-white/15 pb-8 md:pb-10">
          <p className="typo-semibold-12 tracking-[0.22em] text-amber-500 uppercase">Terms of Service</p>
        ...
        <div className="divide-y divide-white/10">
          {TERMS_SECTIONS.map((section) => (
            <section key={section.title} className="py-7 md:py-9">
              ...
              <div className="typo-medium-14 mt-4 space-y-2.5 leading-7 text-gray-300 md:text-[15px]">
        ...
        <section className="border-t border-white/15 pt-7 md:pt-9">
          ...
          <p className="typo-medium-14 mt-4 leading-7 text-gray-300 md:text-[15px]">
            이 약관은 {TERMS_EFFECTIVE_DATE}부터 시행합니다.
          </p>
        </section>

        <aside className="typo-medium-14 mt-10 border border-white/10 bg-white/5 p-5 leading-6 text-gray-300 md:p-6">
