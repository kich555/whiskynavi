 ...
 */
export default function PostDetailShell({ header, content, actions }: PostDetailShellProps) {
  return (
    <div className="mx-auto mt-20 min-h-screen max-w-[1440px] bg-[#1d2429]">
      <div className="mx-auto max-w-3xl px-4 py-6">
        ...
        <div className="overflow-hidden rounded-xl border border-white/10 bg-white/5">
          ...
          {/* 본문 (TipTap HTML) */}
          <div
            className="prose prose-sm max-w-none px-5 py-5 [&_*]:text-white [&_img]:text-transparent [&_img]:my-4 [&_img]:rounded-lg"
